...
I see an overall positive trend in the plot. This means that over time, the global temperature is deviating more from the long-term average from 1951 to 1980. It also means that the average global temperature is increasing
...
I used the prompt: "how to calculate a rolling average in R with example" in chatGPT. It gave me a few outputs with different packages, and I decided on the slider package because its within tidyverse. I had to switch the column names and add more columns from the example output to get what I needed.
